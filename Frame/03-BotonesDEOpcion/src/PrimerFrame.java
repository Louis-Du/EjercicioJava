...
public class PrimerFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setName("chkRojo"); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String opcionSeleccionado = "El color que escogiste fue: ";

        if (jRadioButton1.isSelected())
        {
            opcionSeleccionado = opcionSeleccionado + "Rojo";
        }

        if (jRadioButton2.isSelected())
        {
            opcionSeleccionado = opcionSeleccionado + "Verde";
        }
        
        if (jRadioButton3.isSelected())
        {
            opcionSeleccionado = opcionSeleccionado + "Azul";
        }
        
        jTextField1.setText(opcionSeleccionado);
